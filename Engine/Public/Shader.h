...
public:
	...
	HRESULT Bind_SRVs(const _char* pConstantName, ID3D11ShaderResourceView** ppSRV, _uint iNumTextures = 1);
	HRESULT Bind_Float(const _char* pConstantName, const _float& fValue);
private:
