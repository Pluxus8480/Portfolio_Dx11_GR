...
void CCollider::Collision_Enter(CCollider* pTargetCollider)
{
...
HRESULT CCollider::Render()
{
	if (GAMEINSTANCE->Get_DebugMode()) {
		...
		m_pEffect->SetView(m_pGameInstance->Get_Transform_Matrix(CCamera_Manager::D3DTS_VIEW));
		m_pEffect->SetProjection(m_pGameInstance->Get_Transform_Matrix(CCamera_Manager::D3DTS_PROJ));
